...
####
medidasVal<- function(data,clust,truth,method='clustering'){#saca medidas de acuerdo segun indice de variacion, indicen rand y medidas de validacion interna como la silueta
